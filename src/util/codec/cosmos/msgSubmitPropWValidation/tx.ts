...
export const MsgSubmitPropWValidation = {
  encode(
    message: MsgSubmitPropWValidation,
  ...
  fromJSON(object: any): MsgSubmitPropWValidation {
    ...
    if (Array.isArray(object?.initialDeposit))
      obj.initialDeposit = object.initialDeposit.map((e: any) =>
        Coin.fromJSON(e),
      );
    ...
    if (isSet(object.expedited)) obj.expedited = object.expedited;
    return obj;
  },
  ...
  create<I extends Exact<DeepPartial<MsgSubmitPropWValidation>, I>>(
    base?: I,
  ): MsgSubmitPropWValidation {
    return MsgSubmitPropWValidation.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgSubmitPropWValidation>, I>>(
    object: I,
  ): MsgSubmitPropWValidation {
    const message = createBaseMsgSubmitPropWValidation();
...
export const MsgSubmitPropWValidationResponse = {
  encode(
    message: MsgSubmitPropWValidationResponse,
  ...
  decode(
    input: _m0.BinaryReader | Uint8Array,
    length?: number,
  ): MsgSubmitPropWValidationResponse {
    const reader =
      input instanceof _m0.BinaryReader ? input : new _m0.BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create<I extends Exact<DeepPartial<MsgSubmitPropWValidationResponse>, I>>(
    base?: I,
  ): MsgSubmitPropWValidationResponse {
  ...
  fromPartial<
    I extends Exact<DeepPartial<MsgSubmitPropWValidationResponse>, I>,
  >(object: I): MsgSubmitPropWValidationResponse {
    const message = createBaseMsgSubmitPropWValidationResponse();
...
export interface Msg {
  SubmitPropWValidation(
    request: MsgSubmitPropWValidation,
  ): Promise<MsgSubmitPropWValidationResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  SubmitPropWValidation(
    ...
    return promise.then((data) =>
      MsgSubmitPropWValidationResponse.decode(new BinaryReader(data)),
    );
  }
}
