...
const contractsOwnerPrivKey = fromHex(
  process.env.CONTRACTS_OWNER_KEY as string,
);
...
export async function getContractsOwnerWallet(): Promise<NolusWallet> {
  return await getWallet(contractsOwnerPrivKey);
}
