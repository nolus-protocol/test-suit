...
export class MsgClientImpl implements Msg {
  ...
  async Suspend(request: MsgSuspend): Promise<MsgSuspendResponse> {
    ...
    return MsgSuspendResponse.decode(new _m0.Reader(data_1));
  }

  async Unsuspend(request: MsgUnsuspend): Promise<MsgUnsuspendResponse> {
    ...
    const data_1 = await promise;
    return MsgUnsuspendResponse.decode(new _m0.Reader(data_1));
  }
}
